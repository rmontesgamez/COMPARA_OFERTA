...
HAVING (((PIEZAS.REF_C) Like '%""" + self.e_pedido + "%') AND ((PEDIDOS.COMPLETADO)='N')) ORDER BY PEDIDOS.PEDIDO;"
           ...
           SELECT Max((PIEZAS.REF_N))  FROM PIEZAS;"""
            ...
            sql_query=("""
            SELECT OFERTAS.OFERTA, PZOFERTA.REF, PIEZAS.REF_N, PIEZAS.C_VR, PZOFERTA.QPZ, PIEZAS.TRATMTO, PZOFERTA.VPU, PZOFERTA.VPZ, PZOFERTA.PROPMAT, PZOFERTA.PR_TRANSPORTE, PIEZAS.VGAS, PIEZAS.VCORTE, PZOFERTA.VTRATMTO
